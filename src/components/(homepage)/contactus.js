            ...
            <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                ...
                <div class="bg-gray-100 p-6 rounded-lg">
                    ...
                    <div class="space-y-4 max-lg:mt-4">
                        <button type="button" class="px-4 py-2 rounded-lg bg-[#408b70] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#408b70] mr-4">Web design</button>
                    ...
                    <form class="mt-8 space-y-4">
                        ...
                        <textarea placeholder='Message' rows="6"
                            class="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#408b70]"></textarea>
                        <button type='button'
                            class="text-white bg-[#408b70] hover:bg-[#a91079e2] tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
