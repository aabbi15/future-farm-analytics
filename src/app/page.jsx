                ...
                <section id="keyfeatures" className="w-full flex justify-center items-center py-12 md:py-24 lg:py-32 bg-[#f0f4d4]">
                    <div className="container px-4 md:px-6">
                        ...
                        <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
                            <img src="https://wallpapers.com/images/hd/agriculture-farming-field-djd3ffforta0zitn.jpg" width="550" height="310" alt="Image" className="mx-auto aspect-video overflow-hidden rounded-xl object-cover object-center sm:w-full lg:order-last" />
                                ...
                                <ul className="grid gap-6">
                                    <li>
                                        <div className="bg-[#b1d4c7] rounded-xl pt-4 pb-4 pl-4 grid gap-1">
                                            ...
                                            <p className="text-black">Our advanced algorithms analyze market trends and environmental data to predict future prices and yields.
                                            </p>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="bg-[#b1d4c7] rounded-xl pt-4 pb-4 pl-4 grid gap-1">
                                            ...
                                            <p className="text-black">Get instant access to up-to-date information on commodity prices, weather patterns, and market conditions.
                                            </p>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="bg-[#b1d4c7] rounded-xl pt-4 pb-4 pl-4 grid gap-1">
                                            ...
                                            <p className="text-black">Set custom alerts to stay informed about changes in market and optimize your planting and harvesting schedules.
                                            </p>
                                        </div>
                                    </li>
                                </ul>
