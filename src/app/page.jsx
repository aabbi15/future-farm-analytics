        ...
        <header className="absolute inset-x-0 top-0 z-50">
          <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div className="lg:flex lg:gap-x-12">
              <a href="#" className="text-sm hover:underline underline-offset-4 font-semibold leading-6 text-gray-900">Product</a>
              <a href="#" className="text-sm hover:underline underline-offset-4 font-semibold leading-6 text-gray-900">Features</a>
              <a href="#" className="text-sm hover:underline underline-offset-4 font-semibold leading-6 text-gray-900">Marketplace</a>
              <a href="#" className="text-sm hover:underline underline-offset-4 font-semibold leading-6 text-gray-900">Company</a>
            </div>
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a href="#" className="rounded-md bg-[#124b3d] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#12493ccd] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</a>
